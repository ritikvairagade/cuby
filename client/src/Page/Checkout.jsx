      ...
      <div className="w-full md:w-3/5 rounded-lg  py-3 shadow-lg bg-white flex flex-col items-center">
        ...
        <div className="flex w-full  flex-col gap-2 items-center">
          ...
          <div className="flex w-full  flex-col items-center text-gray-400">
            ...
            <small>Nagpur Rd, Civil Lines, Chandrapur</small>
          </div>
        ...
        <button className="flex items-center gap-2 justify-center my-4 md:my-8 w-full px-4 md:w-4/5 px-0 h-14 text-white font-medium text-lg bg-cuby-400 rounded-lg">
